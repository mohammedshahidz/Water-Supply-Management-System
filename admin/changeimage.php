...
$bottleimg=md5($bimg).$extension;
    ...
    $query=mysqli_query($con, "update tblwaterbottle set Image ='$bottleimg' where ID='$imgid'");
    if ($query) {
    $msg="Bottle image has been updated.";
  }
  else
    {
...
<html>
<head>
<title>Water Supply Management System | Update Bottle Image</title>
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Update Bottle Image
            </ol>
		<!--grid-->
 	<div class="grid-form">
  ...
  <?php
 $imgid=$_GET['imageid'];
$ret=mysqli_query($con,"select * from tblwaterbottle where ID='$imgid'");
$cnt=1;
