...
<html>
<head>
<title>Water Supply Management System | Contact Us</title>
...
?>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="email" name="email" id="email" value="<?php  echo $row['Email'];?>" class="form-control1 input-sm" required='true'>
									</div>
								</div>
								<div class="form-group">
									<label for="smallinput" class="col-sm-2 control-label label-input-sm">Page Title</label>
									<div class="col-sm-8">
										<input type="text" name="mobnum" id="mobnum" value="<?php  echo $row['MobileNumber'];?>" class="form-control1 input-sm" required='true' maxlength="10" pattern='[0-9]+'>
									</div>
								</div>
								<div class="form-group">
